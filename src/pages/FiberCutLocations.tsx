  ...
  return (
    <div className="h-[calc(100vh-5rem)] flex flex-col p-6 space-y-4 bg-background transition-colors">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shrink-0">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-foreground">Fiber Cut Map</h2>
          <p className="text-sm text-muted-foreground mt-1">Geographic distribution of fiber cuts</p>
        </div>
